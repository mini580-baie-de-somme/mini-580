...
const messages = {
  ...
  "nav.externalLinks": { fr: "Liens", en: "Links" },
  ...
  "editor.filters.toggle": { fr: "Filtres", en: "Filters" },
  "editor.filters.search": { fr: "Recherche", en: "Search" },
  "editor.filters.remove": { fr: "Retirer ce filtre", en: "Remove this filter" },
  "editor.filters.clearAll": { fr: "Tout effacer", en: "Clear all" },
  ...
  "externalLinks.title": { fr: "Liens externes", en: "External links" },
  "externalLinks.subtitle": {
    fr: "Liens réutilisables insérables dans le corps des articles (FR/EN).",
    en: "Reusable links that can be inserted into article bodies (FR/EN).",
  },
  "externalLinks.new": { fr: "Nouveau lien", en: "New link" },
  "externalLinks.edit": { fr: "Modifier le lien", en: "Edit link" },
  "externalLinks.labelFr": { fr: "Libellé FR", en: "French label" },
  "externalLinks.labelEn": { fr: "Libellé EN", en: "English label" },
  "externalLinks.urlModeSingle": { fr: "URL unique (les deux langues)", en: "Single URL (both locales)" },
  "externalLinks.urlModeBilingual": { fr: "URLs séparées FR / EN", en: "Separate FR / EN URLs" },
  "externalLinks.url": { fr: "URL", en: "URL" },
  "externalLinks.urlFr": { fr: "URL FR", en: "French URL" },
  "externalLinks.urlEn": { fr: "URL EN", en: "English URL" },
  "externalLinks.save": { fr: "Enregistrer", en: "Save" },
  "externalLinks.cancel": { fr: "Annuler", en: "Cancel" },
  "externalLinks.colLabel": { fr: "Libellé", en: "Label" },
  "externalLinks.colUrl": { fr: "URL", en: "URL" },
  "externalLinks.empty": { fr: "Aucun lien.", en: "No links yet." },
  "externalLinks.saveError": { fr: "Enregistrement impossible.", en: "Save failed." },
  "externalLinks.deleteError": { fr: "Suppression impossible.", en: "Delete failed." },
  "externalLinks.deleteInUse": {
    fr: "Ce lien est utilisé dans au moins un article — retirez-le du corps avant suppression.",
    en: "This link is used in at least one article — remove it from the body before deleting.",
  },
  "externalLinks.deleteConfirm": {
    fr: "Supprimer le lien « {name} » ?",
    en: "Delete link “{name}”?",
  },
  "externalLinks.delete": { fr: "Supprimer", en: "Delete" },
  "externalLinks.search": { fr: "Rechercher un lien…", en: "Search links…" },
  ...
  "externalLink.missingChip": {
    ...
    en: "External link not found",
  },
  "externalLink.missingUrl": {
    fr: "Lien externe sans URL configurée",
    en: "External link has no configured URL",
  },
  "externalLink.loadingChip": { fr: "Chargement…", en: "Loading…" },
  "externalLink.removeFromBody": { fr: "Retirer du corps", en: "Remove from body" },
  "externalLink.edit": { fr: "Lien externe", en: "External link" },
  ...
  "mediaGroup.new": { fr: "Nouveau groupe", en: "New group" },
  "mediaGroup.edit": { fr: "Groupe de médias", en: "Media group" },
  "mediaGroup.filter": { fr: "Groupe", en: "Group" },
  "mediaGroup.filterAll": { fr: "Tous les groupes", en: "All groups" },
  "mediaGroup.members": { fr: "Médias du groupe", en: "Group media" },
  "mediaGroup.addMedia": { fr: "Ajouter un média", en: "Add media" },
  "mediaGroup.removeMedia": { fr: "Retirer", en: "Remove" },
  "mediaGroup.searchMedia": { fr: "Rechercher un média…", en: "Search media…" },
  "mediaGroup.emptyMembers": {
    fr: "Aucun média — ajoute-en depuis la médiathèque.",
    en: "No media yet — add from the library.",
  },
  ...
  "mediaGroup.layoutSingle": { fr: "Simple", en: "Single" },
  "mediaGroup.referencedIn": { fr: "Articles", en: "Posts" },
  "mediaGroup.notReferenced": {
    fr: "Aucun article ne référence ce groupe.",
  ...
  "mediaGroup.deleteError": { fr: "Suppression impossible.", en: "Delete failed." },
  "mediaGroup.deleteBlocked": {
    fr: "Référencé dans {n} article(s) — retire les blocs inline d’abord.",
    en: "Referenced in {n} post(s) — remove inline blocks first.",
  },
  "mediaGroup.loadError": { fr: "Chargement impossible.", en: "Failed to load." },
  "mediaGroup.saveError": { fr: "Enregistrement impossible.", en: "Save failed." },
  "mediaGroup.saving": { fr: "Enregistrement…", en: "Saving…" },
  "mediaGroup.saved": { fr: "Enregistré", en: "Saved" },
  "mediaGroup.autosave": { fr: "Sauvegarde auto", en: "Auto-save" },
  "mediaGroup.moveUp": { fr: "Monter", en: "Move up" },
  "mediaGroup.moveDown": { fr: "Descendre", en: "Move down" },
  "mediaGroup.inGroups": { fr: "Groupes", en: "Groups" },
  "mediaGroup.none": { fr: "Aucun groupe", en: "No groups" },
  "mediaGroup.insertTitle": { fr: "Insérer un groupe de médias", en: "Insert media group" },
  "mediaGroup.searchGroups": { fr: "Rechercher un groupe…", en: "Search groups…" },
  "mediaGroup.emptyPicker": { fr: "Aucun groupe trouvé.", en: "No groups found." },
  "mediaGroup.loadingChip": { fr: "Chargement…", en: "Loading…" },
  "mediaGroup.missingChip": { fr: "Groupe introuvable", en: "Group not found" },
  "mediaGroup.removeFromBody": {
